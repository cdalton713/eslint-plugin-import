...
//           zones: [
//             {
//               target: (/^\.\/tests\/files\/restricted-paths\/server$/).toString(),
//               from: (/^\/tests\/files\/restricted-paths\/other$/).toString(),
//             },
//           ],
//         },
//       ],
    ...
    ruleTester.run('no-restricted-paths', rule, {
      ...
      invalid: [
        ...
        test({
          ...
          filename: testFilePath('./restricted-paths/client/a.ts'),
          options: [{
            zones: [{ target: (/.*\/tests\/files\/restricted-paths\/client\/.*/).toString(), from: (/.*\/tests\/files\/restricted-paths\/server.*/).toString() }],
          }],
          errors: [{
            message: 'Unexpected path "../server/b" imported in restricted zone.',
            line: 1,
